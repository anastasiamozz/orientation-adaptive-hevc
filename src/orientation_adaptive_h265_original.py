...
def adaptation(M, delta_qp, zones, frame_size, psi_deg, beta):
    ...
    dqp = dqp_motion + beta * delta_qp * (V_bar - V)
...
def main():
    ...
    P, dqp, qoffset, dispersion, V, alpha = adaptation(
        M, DELTA_QP, zones, coding_frame_size, coding_psi, BETA)
